...
export const BRAND_RELEASES_URL = process.env.NEXT_PUBLIC_ELEMATE_RELEASES_URL || "https://github.com/your-org/elemate/releases";
...
export const BRAND_MIN_OS = "macOS 14 이상";
